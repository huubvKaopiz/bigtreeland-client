import { LikeOutlined, MessageOutlined, TeamOutlined } from "@ant-design/icons";
import { Button, DatePicker, Descriptions, Image, Layout, List, PageHeader, Space, Table, Tabs } from "antd";
...
export default function ClassDetail(): JSX.Element {
    ...
    console.log("class-detail re-render")
	...
	const todayCol = {
		...
		fixed: false,
		render: function col(st: { id: number; name: string }): JSX.Element {
			return <Checkbox onChange={(e) => handleCheckbox(e, st.id)} />;
		},
	};
			...
			<PageHeader
				...
				footer={
					<Tabs defaultActiveKey="1">
						...
						<TabPane tab="Học tập" key="2"></TabPane>
