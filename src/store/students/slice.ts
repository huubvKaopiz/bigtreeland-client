...
export const actionUpdateStudent = createAsyncThunk("actionUpdaeStudent", async (params:{data:StudentParams, sID:number}) => {
...
export const updateStudentStatus = createAsyncThunk("actionUpdateStudentStatus", async (data:UpdateStudentStatusParams) =>{
    const response = await request({
...
export const studentSlice = createSlice({
    ...
    extraReducers:(builder) =>{
        ...
        builder.addCase(actionGetStudents.pending, (state) => {
